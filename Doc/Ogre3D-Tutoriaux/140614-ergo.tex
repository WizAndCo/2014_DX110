...
Et j'obtiens:
	\begin{center}
	\includegraphics[scale=0.25]{Images/plusieursViewport.png} 
	\end{center}
...
Et j'obtiens:
	\begin{center}
	\includegraphics[scale=0.25]{Images/plusieursViewport2.png} 
	\end{center}
...
\begin{itemize}
\item Un mot m\`ene vers le lien, ci-dessous un clic sur ''lien'' mène au lien spécifi\'e
