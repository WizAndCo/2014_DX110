...
%\item ''CMakeLists.txt donn\`e'' \`a corriger par ''CMakeLists.txt donnéE''

%\item le tilde de la phrase ''sous Ubuntu. Les lignes commencant par \#'' est compris comme tilde accent du s qui suit

%\item ''Ce code de base est en fait le meme'', il mqn un accent circonflexe
...
%\item Il mnq les accents dans le titre de 3.2.1

%\item Il mnq les accents dans le titre de 3.3
%% ? \item Il mnq les accents dans le titre de 3.5

%\item Tous les c c\'edille sont pass\'es \`a la trappe

%\item Faire un retour \`a la ligne apr\`es Ogre dans 3.2.3 ''reconnu par Ogre. Le fichier que j'ai choisi se trouve''

%\item Tous les i accent circonflexe sont pass\'es \`a la trappe
%\item
%\item
%\item
%\item
